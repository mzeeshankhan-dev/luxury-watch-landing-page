...
export default function Hero() {
  ...
  const navigate = (direction: 'next' | 'prev') => {
    ...
    setIsAnimating(true);
    setActiveIndex((prev) =>
      direction === 'next' ? (prev + 1) % WATCHES.length : (prev + 3) % WATCHES.length
    );
  ...
  return (
    <div
      id="top"
      style={{
        backgroundColor: activeWatch.bg,
      ...
      <div className="relative w-full overflow-hidden" style={{ height: '100vh' }}>
        ...
        >
          ...
          <p
            ...
            style={{ color: '#D8D2C2', opacity: 0.78, lineHeight: 1.6, maxWidth: 300 }}
          >
            {activeWatch.blurb}
          </p>
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              style={{ color: '#D8D2C2', opacity: 0.6, letterSpacing: '0.04em' }}
            >
